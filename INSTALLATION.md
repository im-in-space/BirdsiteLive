...
If you want to use the IP Whitelisting functionality (see related [variable](https://github.com/im-in-space/BirdsiteLive/blob/master/VARIABLES.md)) and you are using the nginx reverse proxy set as before, please add the following: 
...
You can find more options available [here](https://github.com/im-in-space/BirdsiteLive/blob/master/VARIABLES.md)
